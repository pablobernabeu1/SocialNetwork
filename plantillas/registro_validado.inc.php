<div class="col-md-6">
  ...
  <input type="email" class="form-control" id="inputEmail4" name="email" placeholder="example@servicio.com" <?php $validador->mostrar_email() ?>>
...
<div class="col-md-6">
  ...
  <input type="text" class="form-control" id="inputAddress" placeholder="pacopepe121" name="nombre" <?php $validador->mostrar_nombre() ?>>
