            ...
            <ul>
                <?php
                  ...
                  if(ControlSesion::sesion_iniciada()){
                    $id_usuario_verificado = $_SESSION["id_usuario"];

                    ?>

                    <li>
                      <a href="<?php echo RUTA_PERFIL . "?var=generico" ?>">
                    ...
                    <li>
                      <a href="<?php echo RUTA_ENTRADAS_FAVORITAS; ?>">
                    ...
                    <li>
                      <a href="<?php echo RUTA_NUEVA_ENTRADA ?>">
